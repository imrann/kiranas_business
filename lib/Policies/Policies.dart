...
class _PoliciesState extends State<Policies> {
  ...
  Widget build(BuildContext context) {
    if (widget.action == "privacy") {
      return Text("""PRIVACY STATEMENT
...
If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at [pointzeroonetech@gmail.com] or mailing us at: [B.K.C, Bandra East,Room no: 401, bldg no:3C]
...
If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer at [pointzeroonetech@gmail.com] or by mail at [B.K.C, Bandra East,Room no: 401, bldg no:3C]



---- """);
    } else if (widget.action == "Terms") {
...
This website is operated by [pointzeroonetech]. Throughout the site, the terms “we”, “us” and “our” refer to [pointzeroonetech]. [pointzeroonetech] offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
...
Please read these Terms of Service carefully before accessing or using our website/app. By accessing or using any part of the site, you agree to be bound by these Terms of Service. If you do not agree to all the terms and conditions of this agreement, then you may not access the website/app or use any services. If these Terms of Service are considered an offer, acceptance is expressly limited to these Terms of Service.
...
You agree to indemnify, defend and hold harmless [pointzeroonetech] and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
...
Questions about the Terms of Service should be sent to us at [pointzeroonetech@gmail.com].
...
If you’ve done all of this and you still have not received your refund yet, please contact us at [pointzeroonetech@gmail.com].
...
We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at [pointzeroonetech@gmail.com] and send your item to: [B.K.C, Bandra East,Room no: 401, bldg no:3C,Bharat Nagar,SRA]
...
To return your product, you should mail your product to: [B.K.C, Bandra East,Room no: 401, bldg no:3C,Bharat Nagar,SRA]
...
If you are shipping an item over 75 dollar, you should consider using a trackable shipping service or purchasing shipping insurance. We don’t guarantee that we will receive your returned item.""");
    } else {
      return null;
    }
  }
